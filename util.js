...
util.getPostQueryString = function (req, res, next) {
  res.locals.getPostQueryString = function (
    isAppended = false,
    overwrites = {}
  ) {
    var queryString = "";
    var queryArray = [];
    var page = overwrites.page
      ? overwrites.page
      : req.query.page
      ? req.query.page
      : "";
    var limit = overwrites.limit
      ? overwrites.limit
      : req.query.limit
      ? req.query.limit
      : "";
    var searchType = overwrites.searchType
      ? overwrites.searchType
      : req.query.searchType
      ? req.query.searchType
      : "";
    var searchText = overwrites.searchText
